...
| source_image | The image name for the disk for the VM instance. | `string` | `"projects/infoblox-public-436917/global/images/nios-x-virtual-server-3-8-1"` | yes |
| zone | The zone for the solution to be deployed. | `string` | `"us-east1-b"` | no |
| machine_type | The machine type to create, e.g. e2-small | `string` | `"n2-standard-8"` | no |
| boot_disk_type | The boot disk type for the VM instance. | `string` | `"pd-ssd"` | no |
| boot_disk_size | The boot disk size for the VM instance in GBs | `number` | `60` | no |
