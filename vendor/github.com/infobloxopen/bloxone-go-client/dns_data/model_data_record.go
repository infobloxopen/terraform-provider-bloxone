...
func NewDataRecord(rdata map[string]interface{}) *DataRecord {
	this := DataRecord{}
	this.Rdata = rdata
	return &this
}
...
// SetInheritanceSources gets a reference to the given DataRecordInheritance and assigns it to the InheritanceSources field.
...
func (o *DataRecord) HasNameInZone() bool {
	if o != nil && !IsNil(o.NameInZone) {
		return true
	}
...
func (o *DataRecord) GetRdata() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
...
func (o *DataRecord) SetSubtype(v string) {
	o.Subtype = &v
}
...
func (o *DataRecord) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
