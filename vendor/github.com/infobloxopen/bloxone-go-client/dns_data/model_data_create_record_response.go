...
// checks if the DataCreateRecordResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataCreateRecordResponse{}

// DataCreateRecordResponse The response format to create the __Record__ object.
...
func (o DataCreateRecordResponse) MarshalJSON() ([]byte, error) {
...
func (o DataCreateRecordResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDataCreateRecordResponse struct {
	value *DataCreateRecordResponse
	isSet bool
}

func (v NullableDataCreateRecordResponse) Get() *DataCreateRecordResponse {
	return v.value
}

func (v *NullableDataCreateRecordResponse) Set(val *DataCreateRecordResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDataCreateRecordResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDataCreateRecordResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataCreateRecordResponse(val *DataCreateRecordResponse) *NullableDataCreateRecordResponse {
	return &NullableDataCreateRecordResponse{value: val, isSet: true}
}

func (v NullableDataCreateRecordResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataCreateRecordResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
