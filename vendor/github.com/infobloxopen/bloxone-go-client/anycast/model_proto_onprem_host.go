...
// checks if the ProtoOnpremHost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtoOnpremHost{}

// ProtoOnpremHost struct for ProtoOnpremHost
type ProtoOnpremHost struct {
	AnycastConfigRefs []ProtoAnycastConfigRef `json:"anycast_config_refs,omitempty"`
	ConfigBgp         *ProtoBgpConfig         `json:"config_bgp,omitempty"`
	ConfigOspf        *ProtoOspfConfig        `json:"config_ospf,omitempty"`
	ConfigOspfv3      *ProtoOspfv3Config      `json:"config_ospfv3,omitempty"`
...
// SetAnycastConfigRefs gets a reference to the given []ProtoAnycastConfigRef and assigns it to the AnycastConfigRefs field.
...
// SetConfigBgp gets a reference to the given ProtoBgpConfig and assigns it to the ConfigBgp field.
...
// SetConfigOspf gets a reference to the given ProtoOspfConfig and assigns it to the ConfigOspf field.
...
// SetConfigOspfv3 gets a reference to the given ProtoOspfv3Config and assigns it to the ConfigOspfv3 field.
...
func (o ProtoOnpremHost) MarshalJSON() ([]byte, error) {
...
func (o ProtoOnpremHost) ToMap() (map[string]interface{}, error) {
...
type NullableProtoOnpremHost struct {
	value *ProtoOnpremHost
	isSet bool
}

func (v NullableProtoOnpremHost) Get() *ProtoOnpremHost {
	return v.value
}

func (v *NullableProtoOnpremHost) Set(val *ProtoOnpremHost) {
	v.value = val
	v.isSet = true
}

func (v NullableProtoOnpremHost) IsSet() bool {
	return v.isSet
}

func (v *NullableProtoOnpremHost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtoOnpremHost(val *ProtoOnpremHost) *NullableProtoOnpremHost {
	return &NullableProtoOnpremHost{value: val, isSet: true}
}

func (v NullableProtoOnpremHost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtoOnpremHost) UnmarshalJSON(src []byte) error {
	v.isSet = true
