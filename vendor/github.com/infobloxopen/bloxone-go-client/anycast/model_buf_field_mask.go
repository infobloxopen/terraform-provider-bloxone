...
func (o BufFieldMask) MarshalJSON() ([]byte, error) {
...
func (o BufFieldMask) ToMap() (map[string]interface{}, error) {
...
func (o *BufFieldMask) UnmarshalJSON(data []byte) (err error) {
	varBufFieldMask := _BufFieldMask{}

	err = json.Unmarshal(data, &varBufFieldMask)

	if err != nil {
		return err
	}

	*o = BufFieldMask(varBufFieldMask)
...
type NullableBufFieldMask struct {
	value *BufFieldMask
	isSet bool
}

func (v NullableBufFieldMask) Get() *BufFieldMask {
	return v.value
}

func (v *NullableBufFieldMask) Set(val *BufFieldMask) {
	v.value = val
	v.isSet = true
}

func (v NullableBufFieldMask) IsSet() bool {
	return v.isSet
}

func (v *NullableBufFieldMask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBufFieldMask(val *BufFieldMask) *NullableBufFieldMask {
	return &NullableBufFieldMask{value: val, isSet: true}
}

func (v NullableBufFieldMask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBufFieldMask) UnmarshalJSON(src []byte) error {
	v.isSet = true
