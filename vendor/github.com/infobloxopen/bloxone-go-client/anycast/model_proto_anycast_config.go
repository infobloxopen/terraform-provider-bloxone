...
// checks if the ProtoAnycastConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtoAnycastConfig{}

// ProtoAnycastConfig struct for ProtoAnycastConfig
type ProtoAnycastConfig struct {
	...
	OnpremHosts        []ProtoOnpremHostRef   `json:"onprem_hosts,omitempty"`
...
// SetOnpremHosts gets a reference to the given []ProtoOnpremHostRef and assigns it to the OnpremHosts field.
...
func (o ProtoAnycastConfig) MarshalJSON() ([]byte, error) {
...
func (o ProtoAnycastConfig) ToMap() (map[string]interface{}, error) {
...
type NullableProtoAnycastConfig struct {
	value *ProtoAnycastConfig
	isSet bool
}

func (v NullableProtoAnycastConfig) Get() *ProtoAnycastConfig {
	return v.value
}

func (v *NullableProtoAnycastConfig) Set(val *ProtoAnycastConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableProtoAnycastConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableProtoAnycastConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtoAnycastConfig(val *ProtoAnycastConfig) *NullableProtoAnycastConfig {
	return &NullableProtoAnycastConfig{value: val, isSet: true}
}

func (v NullableProtoAnycastConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtoAnycastConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
