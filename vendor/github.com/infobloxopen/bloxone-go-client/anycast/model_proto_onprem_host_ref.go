...
// checks if the ProtoOnpremHostRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtoOnpremHostRef{}

// ProtoOnpremHostRef Struct on-prem host reference.
type ProtoOnpremHostRef struct {
...
func (o ProtoOnpremHostRef) MarshalJSON() ([]byte, error) {
...
func (o ProtoOnpremHostRef) ToMap() (map[string]interface{}, error) {
...
type NullableProtoOnpremHostRef struct {
	value *ProtoOnpremHostRef
	isSet bool
}

func (v NullableProtoOnpremHostRef) Get() *ProtoOnpremHostRef {
	return v.value
}

func (v *NullableProtoOnpremHostRef) Set(val *ProtoOnpremHostRef) {
	v.value = val
	v.isSet = true
}

func (v NullableProtoOnpremHostRef) IsSet() bool {
	return v.isSet
}

func (v *NullableProtoOnpremHostRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtoOnpremHostRef(val *ProtoOnpremHostRef) *NullableProtoOnpremHostRef {
	return &NullableProtoOnpremHostRef{value: val, isSet: true}
}

func (v NullableProtoOnpremHostRef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtoOnpremHostRef) UnmarshalJSON(src []byte) error {
	v.isSet = true
