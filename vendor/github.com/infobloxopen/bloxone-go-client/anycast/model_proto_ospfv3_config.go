...
// checks if the ProtoOspfv3Config type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtoOspfv3Config{}

// ProtoOspfv3Config struct for ProtoOspfv3Config
type ProtoOspfv3Config struct {
...
func (o ProtoOspfv3Config) MarshalJSON() ([]byte, error) {
...
func (o ProtoOspfv3Config) ToMap() (map[string]interface{}, error) {
...
type NullableProtoOspfv3Config struct {
	value *ProtoOspfv3Config
	isSet bool
}

func (v NullableProtoOspfv3Config) Get() *ProtoOspfv3Config {
	return v.value
}

func (v *NullableProtoOspfv3Config) Set(val *ProtoOspfv3Config) {
	v.value = val
	v.isSet = true
}

func (v NullableProtoOspfv3Config) IsSet() bool {
	return v.isSet
}

func (v *NullableProtoOspfv3Config) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtoOspfv3Config(val *ProtoOspfv3Config) *NullableProtoOspfv3Config {
	return &NullableProtoOspfv3Config{value: val, isSet: true}
}

func (v NullableProtoOspfv3Config) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtoOspfv3Config) UnmarshalJSON(src []byte) error {
	v.isSet = true
