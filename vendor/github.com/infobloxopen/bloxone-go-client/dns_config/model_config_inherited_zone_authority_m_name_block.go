...
// checks if the ConfigInheritedZoneAuthorityMNameBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigInheritedZoneAuthorityMNameBlock{}

// ConfigInheritedZoneAuthorityMNameBlock Inheritance block for fields: _mname_, _protocol_mname_, _default_mname_.
...
func NewConfigInheritedZoneAuthorityMNameBlock() *ConfigInheritedZoneAuthorityMNameBlock {
	this := ConfigInheritedZoneAuthorityMNameBlock{}
	return &this
}
...
func (o *ConfigInheritedZoneAuthorityMNameBlock) GetValue() ConfigZoneAuthorityMNameBlock {
	if o == nil || IsNil(o.Value) {
		var ret ConfigZoneAuthorityMNameBlock
		return ret
	}
	return *o.Value
}
...
// SetValue gets a reference to the given ConfigZoneAuthorityMNameBlock and assigns it to the Value field.
func (o *ConfigInheritedZoneAuthorityMNameBlock) SetValue(v ConfigZoneAuthorityMNameBlock) {
	o.Value = &v
}

func (o ConfigInheritedZoneAuthorityMNameBlock) MarshalJSON() ([]byte, error) {
...
func (o ConfigInheritedZoneAuthorityMNameBlock) ToMap() (map[string]interface{}, error) {
...
type NullableConfigInheritedZoneAuthorityMNameBlock struct {
	value *ConfigInheritedZoneAuthorityMNameBlock
	isSet bool
}

func (v NullableConfigInheritedZoneAuthorityMNameBlock) Get() *ConfigInheritedZoneAuthorityMNameBlock {
	return v.value
}

func (v *NullableConfigInheritedZoneAuthorityMNameBlock) Set(val *ConfigInheritedZoneAuthorityMNameBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigInheritedZoneAuthorityMNameBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigInheritedZoneAuthorityMNameBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigInheritedZoneAuthorityMNameBlock(val *ConfigInheritedZoneAuthorityMNameBlock) *NullableConfigInheritedZoneAuthorityMNameBlock {
	return &NullableConfigInheritedZoneAuthorityMNameBlock{value: val, isSet: true}
}

func (v NullableConfigInheritedZoneAuthorityMNameBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigInheritedZoneAuthorityMNameBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
