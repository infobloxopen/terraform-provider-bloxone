...
type AuthNsgAPI interface {
	...
	*/
	...
	// AuthNsgUpdateExecute executes the request
	//  @return ConfigUpdateAuthNSGResponse
	AuthNsgUpdateExecute(r ApiAuthNsgUpdateRequest) (*ConfigUpdateAuthNSGResponse, *http.Response, error)
}
...
func (r ApiAuthNsgCreateRequest) Execute() (*ConfigCreateAuthNSGResponse, *http.Response, error) {
	return r.ApiService.AuthNsgCreateExecute(r)
}
...
func (r ApiAuthNsgDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.AuthNsgDeleteExecute(r)
}
...
func (r ApiAuthNsgListRequest) Tfilter(tfilter string) ApiAuthNsgListRequest {
	r.tfilter = &tfilter
	return r
}

// This parameter is used for sorting by tags.
func (r ApiAuthNsgListRequest) TorderBy(torderBy string) ApiAuthNsgListRequest {
	r.torderBy = &torderBy
	return r
}

func (r ApiAuthNsgListRequest) Execute() (*ConfigListAuthNSGResponse, *http.Response, error) {
	return r.ApiService.AuthNsgListExecute(r)
}
...
func (r ApiAuthNsgReadRequest) Execute() (*ConfigReadAuthNSGResponse, *http.Response, error) {
	return r.ApiService.AuthNsgReadExecute(r)
}
...
func (r ApiAuthNsgUpdateRequest) Execute() (*ConfigUpdateAuthNSGResponse, *http.Response, error) {
	return r.ApiService.AuthNsgUpdateExecute(r)
}
