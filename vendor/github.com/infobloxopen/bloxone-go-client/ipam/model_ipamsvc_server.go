...
var _ MappedNullable = &IpamsvcServer{}

// IpamsvcServer A DHCP Config Profile (_dhcp/server_) is a named configuration for specified list of hosts.
...
func (o *IpamsvcServer) GetInheritanceSources() IpamsvcServerInheritance {
	if o == nil || IsNil(o.InheritanceSources) {
		var ret IpamsvcServerInheritance
		return ret
	}
...
// SetInheritanceSources gets a reference to the given IpamsvcServerInheritance and assigns it to the InheritanceSources field.
...
func (o IpamsvcServer) ToMap() (map[string]interface{}, error) {
...
func (v NullableIpamsvcServer) Get() *IpamsvcServer {
	return v.value
}

func (v *NullableIpamsvcServer) Set(val *IpamsvcServer) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamsvcServer) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamsvcServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamsvcServer(val *IpamsvcServer) *NullableIpamsvcServer {
	return &NullableIpamsvcServer{value: val, isSet: true}
}

func (v NullableIpamsvcServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamsvcServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
