...
// checks if the IpamsvcInheritedAsmGrowthBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamsvcInheritedAsmGrowthBlock{}

// IpamsvcInheritedAsmGrowthBlock The inheritance block for ASM fields: _growth_factor_ and _growth_type_.
...
func NewIpamsvcInheritedAsmGrowthBlock() *IpamsvcInheritedAsmGrowthBlock {
	this := IpamsvcInheritedAsmGrowthBlock{}
	return &this
}
...
// SetValue gets a reference to the given IpamsvcAsmGrowthBlock and assigns it to the Value field.
...
func (o IpamsvcInheritedAsmGrowthBlock) ToMap() (map[string]interface{}, error) {
...
type NullableIpamsvcInheritedAsmGrowthBlock struct {
	value *IpamsvcInheritedAsmGrowthBlock
	isSet bool
}

func (v NullableIpamsvcInheritedAsmGrowthBlock) Get() *IpamsvcInheritedAsmGrowthBlock {
	return v.value
}

func (v *NullableIpamsvcInheritedAsmGrowthBlock) Set(val *IpamsvcInheritedAsmGrowthBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamsvcInheritedAsmGrowthBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamsvcInheritedAsmGrowthBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamsvcInheritedAsmGrowthBlock(val *IpamsvcInheritedAsmGrowthBlock) *NullableIpamsvcInheritedAsmGrowthBlock {
	return &NullableIpamsvcInheritedAsmGrowthBlock{value: val, isSet: true}
}

func (v NullableIpamsvcInheritedAsmGrowthBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamsvcInheritedAsmGrowthBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
