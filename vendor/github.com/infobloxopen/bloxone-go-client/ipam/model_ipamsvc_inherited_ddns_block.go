...
// checks if the IpamsvcInheritedDDNSBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamsvcInheritedDDNSBlock{}

// IpamsvcInheritedDDNSBlock The inheritance configuration block for dynamic DNS.
...
func NewIpamsvcInheritedDDNSBlock() *IpamsvcInheritedDDNSBlock {
	this := IpamsvcInheritedDDNSBlock{}
	return &this
}
...
// SetValue gets a reference to the given IpamsvcDDNSBlock and assigns it to the Value field.
func (o *IpamsvcInheritedDDNSBlock) SetValue(v IpamsvcDDNSBlock) {
	o.Value = &v
}

func (o IpamsvcInheritedDDNSBlock) MarshalJSON() ([]byte, error) {
...
func (o IpamsvcInheritedDDNSBlock) ToMap() (map[string]interface{}, error) {
...
type NullableIpamsvcInheritedDDNSBlock struct {
	value *IpamsvcInheritedDDNSBlock
	isSet bool
}

func (v NullableIpamsvcInheritedDDNSBlock) Get() *IpamsvcInheritedDDNSBlock {
	return v.value
}

func (v *NullableIpamsvcInheritedDDNSBlock) Set(val *IpamsvcInheritedDDNSBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamsvcInheritedDDNSBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamsvcInheritedDDNSBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamsvcInheritedDDNSBlock(val *IpamsvcInheritedDDNSBlock) *NullableIpamsvcInheritedDDNSBlock {
	return &NullableIpamsvcInheritedDDNSBlock{value: val, isSet: true}
}

func (v NullableIpamsvcInheritedDDNSBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamsvcInheritedDDNSBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
