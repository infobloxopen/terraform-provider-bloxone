...
// checks if the IpamsvcDDNSBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamsvcDDNSBlock{}

// IpamsvcDDNSBlock The dynamic DNS configuration.
...
func (o IpamsvcDDNSBlock) MarshalJSON() ([]byte, error) {
...
func (o IpamsvcDDNSBlock) ToMap() (map[string]interface{}, error) {
...
type NullableIpamsvcDDNSBlock struct {
	value *IpamsvcDDNSBlock
	isSet bool
}

func (v NullableIpamsvcDDNSBlock) Get() *IpamsvcDDNSBlock {
	return v.value
}

func (v *NullableIpamsvcDDNSBlock) Set(val *IpamsvcDDNSBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamsvcDDNSBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamsvcDDNSBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamsvcDDNSBlock(val *IpamsvcDDNSBlock) *NullableIpamsvcDDNSBlock {
	return &NullableIpamsvcDDNSBlock{value: val, isSet: true}
}

func (v NullableIpamsvcDDNSBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamsvcDDNSBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
