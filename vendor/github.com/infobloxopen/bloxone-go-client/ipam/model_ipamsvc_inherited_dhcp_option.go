...
// checks if the IpamsvcInheritedDHCPOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamsvcInheritedDHCPOption{}

// IpamsvcInheritedDHCPOption The inheritance configuration for a field of type of _OptionItem_.
...
func NewIpamsvcInheritedDHCPOption() *IpamsvcInheritedDHCPOption {
	this := IpamsvcInheritedDHCPOption{}
	return &this
}
...
func (o *IpamsvcInheritedDHCPOption) GetValue() IpamsvcInheritedDHCPOptionItem {
	if o == nil || IsNil(o.Value) {
		var ret IpamsvcInheritedDHCPOptionItem
		return ret
	}
	return *o.Value
}
...
// SetValue gets a reference to the given IpamsvcInheritedDHCPOptionItem and assigns it to the Value field.
func (o *IpamsvcInheritedDHCPOption) SetValue(v IpamsvcInheritedDHCPOptionItem) {
	o.Value = &v
}

func (o IpamsvcInheritedDHCPOption) MarshalJSON() ([]byte, error) {
...
func (o IpamsvcInheritedDHCPOption) ToMap() (map[string]interface{}, error) {
...
type NullableIpamsvcInheritedDHCPOption struct {
	value *IpamsvcInheritedDHCPOption
	isSet bool
}

func (v NullableIpamsvcInheritedDHCPOption) Get() *IpamsvcInheritedDHCPOption {
	return v.value
}

func (v *NullableIpamsvcInheritedDHCPOption) Set(val *IpamsvcInheritedDHCPOption) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamsvcInheritedDHCPOption) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamsvcInheritedDHCPOption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamsvcInheritedDHCPOption(val *IpamsvcInheritedDHCPOption) *NullableIpamsvcInheritedDHCPOption {
	return &NullableIpamsvcInheritedDHCPOption{value: val, isSet: true}
}

func (v NullableIpamsvcInheritedDHCPOption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamsvcInheritedDHCPOption) UnmarshalJSON(src []byte) error {
	v.isSet = true
