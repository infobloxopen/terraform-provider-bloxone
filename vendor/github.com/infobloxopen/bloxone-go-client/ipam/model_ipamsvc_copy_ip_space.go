...
var _ MappedNullable = &IpamsvcCopyIPSpace{}

// IpamsvcCopyIPSpace struct for IpamsvcCopyIPSpace
...
func (o IpamsvcCopyIPSpace) ToMap() (map[string]interface{}, error) {
...
type NullableIpamsvcCopyIPSpace struct {
	value *IpamsvcCopyIPSpace
	isSet bool
}

func (v NullableIpamsvcCopyIPSpace) Get() *IpamsvcCopyIPSpace {
	return v.value
}

func (v *NullableIpamsvcCopyIPSpace) Set(val *IpamsvcCopyIPSpace) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamsvcCopyIPSpace) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamsvcCopyIPSpace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamsvcCopyIPSpace(val *IpamsvcCopyIPSpace) *NullableIpamsvcCopyIPSpace {
	return &NullableIpamsvcCopyIPSpace{value: val, isSet: true}
}

func (v NullableIpamsvcCopyIPSpace) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamsvcCopyIPSpace) UnmarshalJSON(src []byte) error {
	v.isSet = true
