...
// checks if the IpamsvcInheritedDDNSUpdateBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamsvcInheritedDDNSUpdateBlock{}

// IpamsvcInheritedDDNSUpdateBlock The inheritance configuration for ddns_domain and ddns_send_updates.
...
func NewIpamsvcInheritedDDNSUpdateBlock() *IpamsvcInheritedDDNSUpdateBlock {
	this := IpamsvcInheritedDDNSUpdateBlock{}
	return &this
}
...
func (o *IpamsvcInheritedDDNSUpdateBlock) GetValue() IpamsvcDDNSUpdateBlock {
	if o == nil || IsNil(o.Value) {
		var ret IpamsvcDDNSUpdateBlock
		return ret
	}
	return *o.Value
}
...
// SetValue gets a reference to the given IpamsvcDDNSUpdateBlock and assigns it to the Value field.
func (o *IpamsvcInheritedDDNSUpdateBlock) SetValue(v IpamsvcDDNSUpdateBlock) {
	o.Value = &v
}

func (o IpamsvcInheritedDDNSUpdateBlock) MarshalJSON() ([]byte, error) {
...
func (o IpamsvcInheritedDDNSUpdateBlock) ToMap() (map[string]interface{}, error) {
...
type NullableIpamsvcInheritedDDNSUpdateBlock struct {
	value *IpamsvcInheritedDDNSUpdateBlock
	isSet bool
}

func (v NullableIpamsvcInheritedDDNSUpdateBlock) Get() *IpamsvcInheritedDDNSUpdateBlock {
	return v.value
}

func (v *NullableIpamsvcInheritedDDNSUpdateBlock) Set(val *IpamsvcInheritedDDNSUpdateBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamsvcInheritedDDNSUpdateBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamsvcInheritedDDNSUpdateBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamsvcInheritedDDNSUpdateBlock(val *IpamsvcInheritedDDNSUpdateBlock) *NullableIpamsvcInheritedDDNSUpdateBlock {
	return &NullableIpamsvcInheritedDDNSUpdateBlock{value: val, isSet: true}
}

func (v NullableIpamsvcInheritedDDNSUpdateBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamsvcInheritedDDNSUpdateBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
