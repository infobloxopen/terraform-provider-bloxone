...
// checks if the IpamsvcInheritedHostnameRewriteBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamsvcInheritedHostnameRewriteBlock{}

// IpamsvcInheritedHostnameRewriteBlock The inheritance block for fields: _hostname_rewrite_enabled_, _hostname_rewrite_regex_, _hostname_rewrite_char_.
...
func NewIpamsvcInheritedHostnameRewriteBlock() *IpamsvcInheritedHostnameRewriteBlock {
	this := IpamsvcInheritedHostnameRewriteBlock{}
	return &this
}
...
func (o *IpamsvcInheritedHostnameRewriteBlock) GetValue() IpamsvcHostnameRewriteBlock {
	if o == nil || IsNil(o.Value) {
		var ret IpamsvcHostnameRewriteBlock
		return ret
	}
	return *o.Value
}
...
// SetValue gets a reference to the given IpamsvcHostnameRewriteBlock and assigns it to the Value field.
...
func (o IpamsvcInheritedHostnameRewriteBlock) ToMap() (map[string]interface{}, error) {
...
type NullableIpamsvcInheritedHostnameRewriteBlock struct {
	value *IpamsvcInheritedHostnameRewriteBlock
	isSet bool
}

func (v NullableIpamsvcInheritedHostnameRewriteBlock) Get() *IpamsvcInheritedHostnameRewriteBlock {
	return v.value
}

func (v *NullableIpamsvcInheritedHostnameRewriteBlock) Set(val *IpamsvcInheritedHostnameRewriteBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamsvcInheritedHostnameRewriteBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamsvcInheritedHostnameRewriteBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamsvcInheritedHostnameRewriteBlock(val *IpamsvcInheritedHostnameRewriteBlock) *NullableIpamsvcInheritedHostnameRewriteBlock {
	return &NullableIpamsvcInheritedHostnameRewriteBlock{value: val, isSet: true}
}

func (v NullableIpamsvcInheritedHostnameRewriteBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamsvcInheritedHostnameRewriteBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
