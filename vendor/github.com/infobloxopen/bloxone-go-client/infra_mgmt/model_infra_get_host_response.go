...
// checks if the InfraGetHostResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfraGetHostResponse{}

// InfraGetHostResponse struct for InfraGetHostResponse
type InfraGetHostResponse struct {
...
func (o InfraGetHostResponse) MarshalJSON() ([]byte, error) {
...
func (o InfraGetHostResponse) ToMap() (map[string]interface{}, error) {
...
type NullableInfraGetHostResponse struct {
	value *InfraGetHostResponse
	isSet bool
}

func (v NullableInfraGetHostResponse) Get() *InfraGetHostResponse {
	return v.value
}

func (v *NullableInfraGetHostResponse) Set(val *InfraGetHostResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInfraGetHostResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInfraGetHostResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInfraGetHostResponse(val *InfraGetHostResponse) *NullableInfraGetHostResponse {
	return &NullableInfraGetHostResponse{value: val, isSet: true}
}

func (v NullableInfraGetHostResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInfraGetHostResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
