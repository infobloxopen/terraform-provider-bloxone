...
// checks if the InfraListServiceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfraListServiceResponse{}

// InfraListServiceResponse struct for InfraListServiceResponse
type InfraListServiceResponse struct {
	Page    *ApiPageInfo   `json:"page,omitempty"`
	Results []InfraService `json:"results,omitempty"`
}
...
// SetResults gets a reference to the given []InfraService and assigns it to the Results field.
func (o *InfraListServiceResponse) SetResults(v []InfraService) {
	o.Results = v
}

func (o InfraListServiceResponse) MarshalJSON() ([]byte, error) {
...
func (o InfraListServiceResponse) ToMap() (map[string]interface{}, error) {
...
type NullableInfraListServiceResponse struct {
	value *InfraListServiceResponse
	isSet bool
}

func (v NullableInfraListServiceResponse) Get() *InfraListServiceResponse {
	return v.value
}

func (v *NullableInfraListServiceResponse) Set(val *InfraListServiceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInfraListServiceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInfraListServiceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInfraListServiceResponse(val *InfraListServiceResponse) *NullableInfraListServiceResponse {
	return &NullableInfraListServiceResponse{value: val, isSet: true}
}

func (v NullableInfraListServiceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInfraListServiceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
