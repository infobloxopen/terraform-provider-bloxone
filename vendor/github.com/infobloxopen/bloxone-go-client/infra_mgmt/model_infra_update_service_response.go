...
// checks if the InfraUpdateServiceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfraUpdateServiceResponse{}

// InfraUpdateServiceResponse struct for InfraUpdateServiceResponse
type InfraUpdateServiceResponse struct {
...
func NewInfraUpdateServiceResponse() *InfraUpdateServiceResponse {
	this := InfraUpdateServiceResponse{}
	return &this
}
...
func (o InfraUpdateServiceResponse) MarshalJSON() ([]byte, error) {
...
func (o InfraUpdateServiceResponse) ToMap() (map[string]interface{}, error) {
...
type NullableInfraUpdateServiceResponse struct {
	value *InfraUpdateServiceResponse
	isSet bool
}

func (v NullableInfraUpdateServiceResponse) Get() *InfraUpdateServiceResponse {
	return v.value
}

func (v *NullableInfraUpdateServiceResponse) Set(val *InfraUpdateServiceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInfraUpdateServiceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInfraUpdateServiceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInfraUpdateServiceResponse(val *InfraUpdateServiceResponse) *NullableInfraUpdateServiceResponse {
	return &NullableInfraUpdateServiceResponse{value: val, isSet: true}
}

func (v NullableInfraUpdateServiceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInfraUpdateServiceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
