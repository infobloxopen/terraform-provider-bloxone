...
type AtcfwSecurityPolicy struct {
	...
	NetAddressDfps []AtcfwNetAddrDfpAssignment `json:"net_address_dfps,omitempty"`
	...
	Rules []AtcfwSecurityPolicyRule `json:"rules,omitempty"`
...
func (o *AtcfwSecurityPolicy) GetNetAddressDfps() []AtcfwNetAddrDfpAssignment {
	if o == nil || IsNil(o.NetAddressDfps) {
		var ret []AtcfwNetAddrDfpAssignment
		return ret
	}
...
// SetNetAddressDfps gets a reference to the given []AtcfwNetAddrDfpAssignment and assigns it to the NetAddressDfps field.
...
// SetRules gets a reference to the given []AtcfwSecurityPolicyRule and assigns it to the Rules field.
...
func (o AtcfwSecurityPolicy) MarshalJSON() ([]byte, error) {
...
func (o AtcfwSecurityPolicy) ToMap() (map[string]interface{}, error) {
...
type NullableAtcfwSecurityPolicy struct {
	value *AtcfwSecurityPolicy
	isSet bool
}

func (v NullableAtcfwSecurityPolicy) Get() *AtcfwSecurityPolicy {
	return v.value
}

func (v *NullableAtcfwSecurityPolicy) Set(val *AtcfwSecurityPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableAtcfwSecurityPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableAtcfwSecurityPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtcfwSecurityPolicy(val *AtcfwSecurityPolicy) *NullableAtcfwSecurityPolicy {
	return &NullableAtcfwSecurityPolicy{value: val, isSet: true}
}

func (v NullableAtcfwSecurityPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtcfwSecurityPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
