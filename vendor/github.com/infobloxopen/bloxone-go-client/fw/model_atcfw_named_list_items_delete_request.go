...
// checks if the AtcfwNamedListItemsDeleteRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AtcfwNamedListItemsDeleteRequest{}
...
func NewAtcfwNamedListItemsDeleteRequest() *AtcfwNamedListItemsDeleteRequest {
	this := AtcfwNamedListItemsDeleteRequest{}
	return &this
}
...
func (o AtcfwNamedListItemsDeleteRequest) MarshalJSON() ([]byte, error) {
...
func (o AtcfwNamedListItemsDeleteRequest) ToMap() (map[string]interface{}, error) {
...
type NullableAtcfwNamedListItemsDeleteRequest struct {
	value *AtcfwNamedListItemsDeleteRequest
	isSet bool
}

func (v NullableAtcfwNamedListItemsDeleteRequest) Get() *AtcfwNamedListItemsDeleteRequest {
	return v.value
}

func (v *NullableAtcfwNamedListItemsDeleteRequest) Set(val *AtcfwNamedListItemsDeleteRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAtcfwNamedListItemsDeleteRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAtcfwNamedListItemsDeleteRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtcfwNamedListItemsDeleteRequest(val *AtcfwNamedListItemsDeleteRequest) *NullableAtcfwNamedListItemsDeleteRequest {
	return &NullableAtcfwNamedListItemsDeleteRequest{value: val, isSet: true}
}

func (v NullableAtcfwNamedListItemsDeleteRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtcfwNamedListItemsDeleteRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
