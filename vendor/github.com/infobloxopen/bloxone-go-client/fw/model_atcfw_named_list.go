...
func (o AtcfwNamedList) MarshalJSON() ([]byte, error) {
...
func (o AtcfwNamedList) ToMap() (map[string]interface{}, error) {
...
type NullableAtcfwNamedList struct {
	value *AtcfwNamedList
	isSet bool
}

func (v NullableAtcfwNamedList) Get() *AtcfwNamedList {
	return v.value
}

func (v *NullableAtcfwNamedList) Set(val *AtcfwNamedList) {
	v.value = val
	v.isSet = true
}

func (v NullableAtcfwNamedList) IsSet() bool {
	return v.isSet
}

func (v *NullableAtcfwNamedList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtcfwNamedList(val *AtcfwNamedList) *NullableAtcfwNamedList {
	return &NullableAtcfwNamedList{value: val, isSet: true}
}

func (v NullableAtcfwNamedList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtcfwNamedList) UnmarshalJSON(src []byte) error {
	v.isSet = true
