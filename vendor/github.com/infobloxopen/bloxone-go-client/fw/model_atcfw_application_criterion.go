...
// checks if the AtcfwApplicationCriterion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AtcfwApplicationCriterion{}

// AtcfwApplicationCriterion struct for AtcfwApplicationCriterion
...
func NewAtcfwApplicationCriterion() *AtcfwApplicationCriterion {
	this := AtcfwApplicationCriterion{}
	return &this
}
...
func (o AtcfwApplicationCriterion) MarshalJSON() ([]byte, error) {
...
func (o AtcfwApplicationCriterion) ToMap() (map[string]interface{}, error) {
...
type NullableAtcfwApplicationCriterion struct {
	value *AtcfwApplicationCriterion
	isSet bool
}

func (v NullableAtcfwApplicationCriterion) Get() *AtcfwApplicationCriterion {
	return v.value
}

func (v *NullableAtcfwApplicationCriterion) Set(val *AtcfwApplicationCriterion) {
	v.value = val
	v.isSet = true
}

func (v NullableAtcfwApplicationCriterion) IsSet() bool {
	return v.isSet
}

func (v *NullableAtcfwApplicationCriterion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtcfwApplicationCriterion(val *AtcfwApplicationCriterion) *NullableAtcfwApplicationCriterion {
	return &NullableAtcfwApplicationCriterion{value: val, isSet: true}
}

func (v NullableAtcfwApplicationCriterion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtcfwApplicationCriterion) UnmarshalJSON(src []byte) error {
	v.isSet = true
