...
// checks if the AtcfwContentCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AtcfwContentCategory{}
...
func (o AtcfwContentCategory) MarshalJSON() ([]byte, error) {
...
func (o AtcfwContentCategory) ToMap() (map[string]interface{}, error) {
...
type NullableAtcfwContentCategory struct {
	value *AtcfwContentCategory
	isSet bool
}

func (v NullableAtcfwContentCategory) Get() *AtcfwContentCategory {
	return v.value
}

func (v *NullableAtcfwContentCategory) Set(val *AtcfwContentCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableAtcfwContentCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableAtcfwContentCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtcfwContentCategory(val *AtcfwContentCategory) *NullableAtcfwContentCategory {
	return &NullableAtcfwContentCategory{value: val, isSet: true}
}

func (v NullableAtcfwContentCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtcfwContentCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
