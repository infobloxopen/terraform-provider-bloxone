...
// checks if the AtcfwInternalDomainsItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AtcfwInternalDomainsItems{}

// AtcfwInternalDomainsItems struct for AtcfwInternalDomainsItems
...
func NewAtcfwInternalDomainsItems() *AtcfwInternalDomainsItems {
	this := AtcfwInternalDomainsItems{}
	return &this
}
...
func (o AtcfwInternalDomainsItems) MarshalJSON() ([]byte, error) {
...
func (o AtcfwInternalDomainsItems) ToMap() (map[string]interface{}, error) {
...
type NullableAtcfwInternalDomainsItems struct {
	value *AtcfwInternalDomainsItems
	isSet bool
}

func (v NullableAtcfwInternalDomainsItems) Get() *AtcfwInternalDomainsItems {
	return v.value
}

func (v *NullableAtcfwInternalDomainsItems) Set(val *AtcfwInternalDomainsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableAtcfwInternalDomainsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableAtcfwInternalDomainsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtcfwInternalDomainsItems(val *AtcfwInternalDomainsItems) *NullableAtcfwInternalDomainsItems {
	return &NullableAtcfwInternalDomainsItems{value: val, isSet: true}
}

func (v NullableAtcfwInternalDomainsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtcfwInternalDomainsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
