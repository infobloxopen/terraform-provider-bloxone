...
// checks if the AtcfwPoPRegion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AtcfwPoPRegion{}
...
func (o AtcfwPoPRegion) MarshalJSON() ([]byte, error) {
...
func (o AtcfwPoPRegion) ToMap() (map[string]interface{}, error) {
...
type NullableAtcfwPoPRegion struct {
	value *AtcfwPoPRegion
	isSet bool
}

func (v NullableAtcfwPoPRegion) Get() *AtcfwPoPRegion {
	return v.value
}

func (v *NullableAtcfwPoPRegion) Set(val *AtcfwPoPRegion) {
	v.value = val
	v.isSet = true
}

func (v NullableAtcfwPoPRegion) IsSet() bool {
	return v.isSet
}

func (v *NullableAtcfwPoPRegion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtcfwPoPRegion(val *AtcfwPoPRegion) *NullableAtcfwPoPRegion {
	return &NullableAtcfwPoPRegion{value: val, isSet: true}
}

func (v NullableAtcfwPoPRegion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtcfwPoPRegion) UnmarshalJSON(src []byte) error {
	v.isSet = true
