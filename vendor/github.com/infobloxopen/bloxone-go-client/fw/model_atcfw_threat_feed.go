...
// checks if the AtcfwThreatFeed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AtcfwThreatFeed{}
...
func (o AtcfwThreatFeed) MarshalJSON() ([]byte, error) {
...
func (o AtcfwThreatFeed) ToMap() (map[string]interface{}, error) {
...
type NullableAtcfwThreatFeed struct {
	value *AtcfwThreatFeed
	isSet bool
}

func (v NullableAtcfwThreatFeed) Get() *AtcfwThreatFeed {
	return v.value
}

func (v *NullableAtcfwThreatFeed) Set(val *AtcfwThreatFeed) {
	v.value = val
	v.isSet = true
}

func (v NullableAtcfwThreatFeed) IsSet() bool {
	return v.isSet
}

func (v *NullableAtcfwThreatFeed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtcfwThreatFeed(val *AtcfwThreatFeed) *NullableAtcfwThreatFeed {
	return &NullableAtcfwThreatFeed{value: val, isSet: true}
}

func (v NullableAtcfwThreatFeed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtcfwThreatFeed) UnmarshalJSON(src []byte) error {
	v.isSet = true
