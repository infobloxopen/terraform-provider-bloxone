...
// checks if the AtcdfpDfp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AtcdfpDfp{}

// AtcdfpDfp struct for AtcdfpDfp
type AtcdfpDfp struct {
	...
	NetAddrPolicyIds []AtcdfpNetAddrPolicyAssignment `json:"net_addr_policy_ids,omitempty"`
...
func (o *AtcdfpDfp) GetNetAddrPolicyIds() []AtcdfpNetAddrPolicyAssignment {
	if o == nil || IsNil(o.NetAddrPolicyIds) {
		var ret []AtcdfpNetAddrPolicyAssignment
		return ret
	}
...
// SetNetAddrPolicyIds gets a reference to the given []AtcdfpNetAddrPolicyAssignment and assigns it to the NetAddrPolicyIds field.
...
func (o AtcdfpDfp) MarshalJSON() ([]byte, error) {
...
func (o AtcdfpDfp) ToMap() (map[string]interface{}, error) {
...
type NullableAtcdfpDfp struct {
	value *AtcdfpDfp
	isSet bool
}

func (v NullableAtcdfpDfp) Get() *AtcdfpDfp {
	return v.value
}

func (v *NullableAtcdfpDfp) Set(val *AtcdfpDfp) {
	v.value = val
	v.isSet = true
}

func (v NullableAtcdfpDfp) IsSet() bool {
	return v.isSet
}

func (v *NullableAtcdfpDfp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtcdfpDfp(val *AtcdfpDfp) *NullableAtcdfpDfp {
	return &NullableAtcdfpDfp{value: val, isSet: true}
}

func (v NullableAtcdfpDfp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtcdfpDfp) UnmarshalJSON(src []byte) error {
	v.isSet = true
