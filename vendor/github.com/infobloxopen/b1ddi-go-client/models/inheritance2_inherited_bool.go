...
func (m *Inheritance2InheritedBool) contextValidateDisplayName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Inheritance2InheritedBool) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Inheritance2InheritedBool) UnmarshalBinary(b []byte) error {
	var res Inheritance2InheritedBool
