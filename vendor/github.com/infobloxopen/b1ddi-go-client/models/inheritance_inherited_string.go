...
func (m *InheritanceInheritedString) contextValidateDisplayName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InheritanceInheritedString) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InheritanceInheritedString) UnmarshalBinary(b []byte) error {
	var res InheritanceInheritedString
