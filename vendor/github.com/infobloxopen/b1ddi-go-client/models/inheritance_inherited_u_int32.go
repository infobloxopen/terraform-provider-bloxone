...
func (m *InheritanceInheritedUInt32) contextValidateDisplayName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InheritanceInheritedUInt32) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InheritanceInheritedUInt32) UnmarshalBinary(b []byte) error {
	var res InheritanceInheritedUInt32
