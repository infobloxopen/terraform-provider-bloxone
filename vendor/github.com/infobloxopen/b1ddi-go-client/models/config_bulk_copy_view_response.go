...
func (m *ConfigBulkCopyViewResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigBulkCopyViewResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigBulkCopyViewResponse) UnmarshalBinary(b []byte) error {
	var res ConfigBulkCopyViewResponse
