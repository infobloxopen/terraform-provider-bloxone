...
page_title: "bloxone_dns_ns_records Data Source - terraform-provider-bloxone"
subcategory: "DNS"
description: |-
  Retrieves information about existing DNS NS resource records.
---

# bloxone_dns_ns_records (Data Source)
...
- `subtype` (String) The DNS resource record subtype specified in the textual mnemonic format. Valid only in case _type_ is _IBMETA_.
  ...
  | LBDN  | 1            | LBDN record   |
  <br>
- `type` (String) The type of DNS record. This is always `NS`.
