...
- `inheritance_sources` (Attributes) The inheritance configuration. (see [below for nested schema](#nestedatt--results--inheritance_sources))
...
- `value` (Attributes) The inherited value. (see [below for nested schema](#nestedatt--results--inheritance_sources--ddns_block--value))
