...
- `federated_realms` (List of String) Federated realms to which this subnet belongs.
...
- `dhcp_utilization` (Attributes) The utilization of IP addresses within the DHCP ranges of the subnet. (see [below for nested schema](#nestedatt--results--dhcp_utilization))
...
- `threshold` (Attributes) The IP address utilization threshold settings for the subnet. (see [below for nested schema](#nestedatt--results--threshold))
...
- `usage` (List of String) The usage is a combination of indicators, each tracking a specific associated use. Listed below are usage indicators with their meaning:
  ...
  <br>
- `utilization` (Attributes) The IPV4 address utilization statistics of the subnet. (see [below for nested schema](#nestedatt--results--utilization))
- `utilization_v6` (Attributes) The utilization of IPV6 addresses in the subnet. (see [below for nested schema](#nestedatt--results--utilization_v6))
