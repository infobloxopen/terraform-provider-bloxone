...
- `credential_preference` (Attributes) Credential preference. Ex.: '{    "type": "static" or "dynamic",    "access_identifier_type": "role_arn" or "tenant_id" or "project_id"  }'. (see [below for nested schema](#nestedatt--results--credential_preference))
...
- `destinations` (Attributes List) Destinations. (see [below for nested schema](#nestedatt--results--destinations))
