...
- `credential_preference` (Attributes) Credential preference. Ex.: '{    "type": "static" or "dynamic",    "access_identifier_type": "role_arn" or "tenant_id" or "project_id"  }'. (see [below for nested schema](#nestedatt--credential_preference))
