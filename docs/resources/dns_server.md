...
- `recursion_acl` (Attributes List) Optional. Clients must match this ACL to make recursive queries. If this ACL is empty, then the _query_acl_ field will be used instead.  Defaults to empty. (see [below for nested schema](#nestedatt--recursion_acl))
...
- `log_query_response` (Attributes) (see [below for nested schema](#nestedatt--inheritance_sources--log_query_response))
...
- `query_port` (Attributes) (see [below for nested schema](#nestedatt--inheritance_sources--query_port))
...
- `recursive_clients` (Attributes) (see [below for nested schema](#nestedatt--inheritance_sources--recursive_clients))
- `resolver_query_timeout` (Attributes) (see [below for nested schema](#nestedatt--inheritance_sources--resolver_query_timeout))
- `secondary_axfr_query_limit` (Attributes) (see [below for nested schema](#nestedatt--inheritance_sources--secondary_axfr_query_limit))
- `secondary_soa_query_limit` (Attributes) (see [below for nested schema](#nestedatt--inheritance_sources--secondary_soa_query_limit))
...
<a id="nestedatt--inheritance_sources--log_query_response"></a>
### Nested Schema for `inheritance_sources.log_query_response`
...
<a id="nestedatt--inheritance_sources--query_port"></a>
### Nested Schema for `inheritance_sources.query_port`
...
<a id="nestedatt--inheritance_sources--recursive_clients"></a>
### Nested Schema for `inheritance_sources.recursive_clients`
...
<a id="nestedatt--inheritance_sources--resolver_query_timeout"></a>
### Nested Schema for `inheritance_sources.resolver_query_timeout`
...
<a id="nestedatt--inheritance_sources--secondary_axfr_query_limit"></a>
### Nested Schema for `inheritance_sources.secondary_axfr_query_limit`
...
<a id="nestedatt--inheritance_sources--secondary_soa_query_limit"></a>
### Nested Schema for `inheritance_sources.secondary_soa_query_limit`
