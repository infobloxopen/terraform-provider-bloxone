...
- `utilization` (Attributes) The utilization of IPV4 addresses in the IP space. (see [below for nested schema](#nestedatt--utilization))
- `utilization_v6` (Attributes) The utilization of IPV6 addresses in the IP space. (see [below for nested schema](#nestedatt--utilization_v6))
...
- `asm_config` (Attributes) The inheritance configuration for _asm_config_ field. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config))
- `ddns_client_update` (Attributes) The inheritance configuration for _ddns_client_update_ field from _IPSpace_ object. (see [below for nested schema](#nestedatt--inheritance_sources--ddns_client_update))
- `ddns_conflict_resolution_mode` (Attributes) The inheritance configuration for _ddns_conflict_resolution_mode_ field from _IPSpace_ object. (see [below for nested schema](#nestedatt--inheritance_sources--ddns_conflict_resolution_mode))
- `ddns_enabled` (Attributes) The inheritance configuration for _ddns_enabled_ field. Only action allowed is 'inherit'. (see [below for nested schema](#nestedatt--inheritance_sources--ddns_enabled))
- `ddns_hostname_block` (Attributes) The inheritance configuration for _ddns_generate_name_ and _ddns_generated_prefix_ fields from _IPSpace_ object. (see [below for nested schema](#nestedatt--inheritance_sources--ddns_hostname_block))
- `ddns_ttl_percent` (Attributes) The inheritance configuration for _ddns_ttl_percent_ field from _IPSpace_ object. (see [below for nested schema](#nestedatt--inheritance_sources--ddns_ttl_percent))
- `ddns_update_block` (Attributes) The inheritance configuration for _ddns_send_updates_ and _ddns_domain_ fields from _IPSpace_ object. (see [below for nested schema](#nestedatt--inheritance_sources--ddns_update_block))
- `ddns_update_on_renew` (Attributes) The inheritance configuration for _ddns_update_on_renew_ field from _IPSpace_ object. (see [below for nested schema](#nestedatt--inheritance_sources--ddns_update_on_renew))
- `ddns_use_conflict_resolution` (Attributes) The inheritance configuration for _ddns_use_conflict_resolution_ field from _IPSpace_ object. (see [below for nested schema](#nestedatt--inheritance_sources--ddns_use_conflict_resolution))
- `dhcp_config` (Attributes) The inheritance configuration for _dhcp_config_ field. (see [below for nested schema](#nestedatt--inheritance_sources--dhcp_config))
...
- `dhcp_options_v6` (Attributes) The inheritance configuration for _dhcp_options_v6_ field. (see [below for nested schema](#nestedatt--inheritance_sources--dhcp_options_v6))
...
- `hostname_rewrite_block` (Attributes) The inheritance configuration for _hostname_rewrite_enabled_, _hostname_rewrite_regex_, and _hostname_rewrite_char_ fields from _IPSpace_ object. (see [below for nested schema](#nestedatt--inheritance_sources--hostname_rewrite_block))
- `vendor_specific_option_option_space` (Attributes) The inheritance configuration for _vendor_specific_option_option_space_ field. (see [below for nested schema](#nestedatt--inheritance_sources--vendor_specific_option_option_space))
...
- `asm_enable_block` (Attributes) The block of ASM fields: _enable_, _enable_notification_, _reenable_date_. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config--asm_enable_block))
- `asm_growth_block` (Attributes) The block of ASM fields: _growth_factor_, _growth_type_. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config--asm_growth_block))
- `asm_threshold` (Attributes) ASM shows the number of addresses forecast to be used _forecast_period_ days in the future, if it is greater than _asm_threshold_percent_ * _dhcp_total_ (see _dhcp_utilization_) then the subnet is flagged. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config--asm_threshold))
- `forecast_period` (Attributes) The forecast period in days. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config--forecast_period))
- `history` (Attributes) The minimum amount of history needed before ASM can run on this subnet. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config--history))
- `min_total` (Attributes) The minimum size of range needed for ASM to run on this subnet. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config--min_total))
- `min_unused` (Attributes) The minimum percentage of addresses that must be available outside of the DHCP ranges and fixed addresses when making a suggested change. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config--min_unused))
...
- `value` (Attributes) The inherited value. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config--asm_enable_block--value))
...
- `display_name` (String) The human-readable display name for the object referred to by _source_.
- `source` (String) The resource identifier.
- `value` (Attributes) The inherited value. (see [below for nested schema](#nestedatt--inheritance_sources--asm_config--asm_growth_block--value))
...
- `display_name` (String) The human-readable display name for the object referred to by _source_.
- `source` (String) The resource identifier.
- `value` (Attributes) The inherited value. (see [below for nested schema](#nestedatt--inheritance_sources--ddns_update_block--value))
...
- `authoritative_dhcp` (Attributes) Set DHCP server as authoritative. (see [below for nested schema](#nestedatt--inheritance_sources--dhcp_config--authoritative_dhcp))
...
- `hold_reclaimed_time` (Attributes) The hold reclaimed time in seconds for IPV4 clients. (see [below for nested schema](#nestedatt--inheritance_sources--dhcp_config--hold_reclaimed_time))
- `hold_reclaimed_time_v6` (Attributes) The hold reclaimed time in seconds for IPV6 clients. (see [below for nested schema](#nestedatt--inheritance_sources--dhcp_config--hold_reclaimed_time_v6))
