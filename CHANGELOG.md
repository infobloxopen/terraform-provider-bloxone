...
ENHANCEMENTS:
* Updated DHCP Config Profile Schema for Inheritance Sources to add support for `hold_reclaimed_time` and `authorized_dhcp`([#237](https://github.com/infobloxopen/terraform-provider-bloxone/pull/237))
