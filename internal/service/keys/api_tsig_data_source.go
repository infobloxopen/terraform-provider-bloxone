...
var _ datasource.DataSource = &TsigDataSource{}

func NewTsigDataSource() datasource.DataSource {
	return &TsigDataSource{}
}
...
func (d *TsigDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_" + "keys_tsigs"
}
...
func (m *KeysTSIGKeyModelWithFilter) FlattenResults(ctx context.Context, from []keys.KeysTSIGKey, diags *diag.Diagnostics) {
	...
	m.Results = flex.FlattenFrameworkListNestedBlock(ctx, from, KeysTSIGKeyAttrTypes, diags, FlattenKeysTSIGKey)
}

func (d *TsigDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Retrieves information about existing TSIG Keys.",
		Attributes: map[string]schema.Attribute{
			...
			"results": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: utils.DataSourceAttributeMap(KeysTSIGKeyResourceSchemaAttributes, &resp.Diagnostics),
				},
				Computed: true,
			},
		},
...
func (d *TsigDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data KeysTSIGKeyModelWithFilter
