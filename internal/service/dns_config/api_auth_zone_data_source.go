...
var _ datasource.DataSource = &AuthZoneDataSource{}

func NewAuthZoneDataSource() datasource.DataSource {
	return &AuthZoneDataSource{}
}
...
func (d *AuthZoneDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_" + "dns_auth_zones"
}
...
func (m *ConfigAuthZoneModelWithFilter) FlattenResults(ctx context.Context, from []dns_config.ConfigAuthZone, diags *diag.Diagnostics) {
	if len(from) == 0 {
		return
	}
...
func (d *AuthZoneDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Retrieves information about existing Authoritative DNS Zones.",
		Attributes: map[string]schema.Attribute{
			...
			"results": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: utils.DataSourceAttributeMap(ConfigAuthZoneResourceSchemaAttributes, &resp.Diagnostics),
				},
				Computed: true,
			},
		},
...
func (d *AuthZoneDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
