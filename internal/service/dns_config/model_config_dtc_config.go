...
func ExpandConfigDTCConfig(ctx context.Context, o types.Object, diags *diag.Diagnostics) *dns_config.ConfigDTCConfig {
...
func (m *ConfigDTCConfigModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dns_config.ConfigDTCConfig {
	if m == nil {
		return nil
	}
	to := &dns_config.ConfigDTCConfig{
		DefaultTtl: flex.ExpandInt64Pointer(m.DefaultTtl),
	}
	return to
}

func FlattenConfigDTCConfig(ctx context.Context, from *dns_config.ConfigDTCConfig, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *ConfigDTCConfigModel) Flatten(ctx context.Context, from *dns_config.ConfigDTCConfig, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
