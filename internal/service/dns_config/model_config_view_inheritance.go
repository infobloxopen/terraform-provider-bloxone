...
func ExpandConfigViewInheritance(ctx context.Context, o types.Object, diags *diag.Diagnostics) *dns_config.ConfigViewInheritance {
	...
	var m ConfigViewInheritanceModel
...
func (m *ConfigViewInheritanceModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dns_config.ConfigViewInheritance {
	...
	to := &dns_config.ConfigViewInheritance{
		...
		DtcConfig:                         ExpandConfigInheritedDtcConfig(ctx, m.DtcConfig, diags),
		EcsBlock:                          ExpandConfigInheritedECSBlock(ctx, m.EcsBlock, diags),
		EdnsUdpSize:                       ExpandInheritance2InheritedUInt32(ctx, m.EdnsUdpSize, diags),
		...
		MaxUdpSize:                        ExpandInheritance2InheritedUInt32(ctx, m.MaxUdpSize, diags),
...
func FlattenConfigViewInheritance(ctx context.Context, from *dns_config.ConfigViewInheritance, diags *diag.Diagnostics) types.Object {
	...
	m := ConfigViewInheritanceModel{}
	m.Flatten(ctx, from, diags)
	t, d := types.ObjectValueFrom(ctx, ConfigViewInheritanceAttrTypes, m)
	diags.Append(d...)
	return t
}
...
func (m *ConfigViewInheritanceModel) Flatten(ctx context.Context, from *dns_config.ConfigViewInheritance, diags *diag.Diagnostics) {
	...
	m.DtcConfig = FlattenConfigInheritedDtcConfig(ctx, from.DtcConfig, diags)
	m.EcsBlock = FlattenConfigInheritedECSBlock(ctx, from.EcsBlock, diags)
	m.EdnsUdpSize = FlattenInheritance2InheritedUInt32(ctx, from.EdnsUdpSize, diags)
	...
	m.MaxUdpSize = FlattenInheritance2InheritedUInt32(ctx, from.MaxUdpSize, diags)
