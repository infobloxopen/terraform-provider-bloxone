...
func ExpandInheritance2InheritedBool(ctx context.Context, o types.Object, diags *diag.Diagnostics) *dnsconfig.Inheritance2InheritedBool {
...
func (m *Inheritance2InheritedBoolModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dnsconfig.Inheritance2InheritedBool {
	if m == nil {
		return nil
	}
	to := &dnsconfig.Inheritance2InheritedBool{
...
func (m *Inheritance2InheritedBoolModel) Flatten(ctx context.Context, from *dnsconfig.Inheritance2InheritedBool, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
