...
func ExpandInheritance2AssignedHost(ctx context.Context, o types.Object, diags *diag.Diagnostics) *dns_config.Inheritance2AssignedHost {
...
func (m *Inheritance2AssignedHostModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dns_config.Inheritance2AssignedHost {
	if m == nil {
		return nil
	}
	to := &dns_config.Inheritance2AssignedHost{
		Host: flex.ExpandStringPointer(m.Host),
	}
	return to
}

func FlattenInheritance2AssignedHost(ctx context.Context, from *dns_config.Inheritance2AssignedHost, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *Inheritance2AssignedHostModel) Flatten(ctx context.Context, from *dns_config.Inheritance2AssignedHost, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
