...
func (d *IpSpaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Retrieves information about existing IP Spaces.\n\nThe IP Space object represents an entire address space.",
		Attributes: map[string]schema.Attribute{
			...
			"results": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: utils.DataSourceAttributeMap(IpamsvcIPSpaceResourceSchemaAttributes, &resp.Diagnostics),
				},
				Computed: true,
			},
		},
...
func (d *IpSpaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data IpamsvcIPSpaceModelWithFilter
