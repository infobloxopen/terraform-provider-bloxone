...
var IpamsvcTSIGKeyResourceSchema = schema.Schema{
	MarkdownDescription: `A __TSIGKey__ object represents a TSIG key.`,
...
func (m *IpamsvcTSIGKeyModel) flatten(ctx context.Context, from *ipam.IpamsvcTSIGKey, diags *diag.Diagnostics) {
	...
	m.ProtocolName = types.StringPointerValue(from.ProtocolName)
	m.Secret = types.StringPointerValue(from.Secret)
