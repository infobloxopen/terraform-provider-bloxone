...
var IpamsvcHostAddressResourceSchema = schema.Schema{
	MarkdownDescription: `The __HostAddress__ object represents addresses associated with a Host object.`,
...
func (m *IpamsvcHostAddressModel) flatten(ctx context.Context, from *ipam.IpamsvcHostAddress, diags *diag.Diagnostics) {
	...
	m.Ref = types.StringValue(from.Ref)
