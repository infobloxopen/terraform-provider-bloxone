...
var IpamsvcIpamHostResourceSchema = schema.Schema{
	MarkdownDescription: `The __IpamHost__ object (_ipam/host_) represents any network connected equipment that is assigned one or more IP addresses.`,
...
func (m *IpamsvcIpamHostModel) expand(ctx context.Context, diags *diag.Diagnostics) *ipam.IpamsvcIpamHost {
	...
	to := &ipam.IpamsvcIpamHost{
		Addresses:           ExpandFrameworkListNestedBlock(ctx, m.Addresses, diags, expandIpamsvcHostAddress),
		AutoGenerateRecords: m.AutoGenerateRecords.ValueBoolPointer(),
		Comment:             m.Comment.ValueStringPointer(),
		HostNames:           ExpandFrameworkListNestedBlock(ctx, m.HostNames, diags, expandIpamsvcHostName),
...
func (m *IpamsvcIpamHostModel) flatten(ctx context.Context, from *ipam.IpamsvcIpamHost, diags *diag.Diagnostics) {
	...
	m.Addresses = FlattenFrameworkListNestedBlock(ctx, from.Addresses, IpamsvcHostAddressAttrTypes, diags, flattenIpamsvcHostAddress)
	...
	m.HostNames = FlattenFrameworkListNestedBlock(ctx, from.HostNames, IpamsvcHostNameAttrTypes, diags, flattenIpamsvcHostName)
